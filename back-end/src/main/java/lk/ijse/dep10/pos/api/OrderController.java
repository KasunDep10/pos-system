...
public class OrderController {
    ...
    public int saveOrder(@RequestBody OrderDTO order) throws Exception{
        ...
        try {
            ...
            PreparedStatement stmOrder = connection.prepareStatement("INSERT INTO `order` (datetime) VALUE (?)", Statement.RETURN_GENERATED_KEYS);
            ...
            /* Let's save the customer details if the order is associate with a customer*/
