...
public class ItemBOImpl implements ItemBO {
    ...
    public ItemBOImpl(ItemDAO itemDAO, OrderDetailDAO orderDetailDAO,
    ...
    public ItemDTO findItemByCode(String itemCode) throws Exception {
        return itemDAO.findById(itemCode).map(transformer::fromItemEntity)
                .orElseThrow(() -> new BusinessException(BusinessExceptionType
                        .RECORD_NOT_FOUND,
    ...
    public List<ItemDTO> findItems(String query) throws Exception {
        return itemDAO.findItems(query).stream().map(transformer::fromItemEntity)
